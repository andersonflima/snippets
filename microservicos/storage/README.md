# storage — microserviço action-driven

Altera storage — tipo (gp3/io1/…) e aumento de tamanho.
...
`POST /storage/execute` — executa a ação. Health: `GET /healthz`, `GET /readyz`.
...
docker run -p 8080:8080 storage
```
