"""API do microserviço servicenow — exposto via API Gateway -> VPC Link -> NLB -> EKS."""
...
from .models import ActionAccepted, ErrorResponse, ServicenowRequest

app = FastAPI(title="servicenow action microservice", version="1.0.0")
