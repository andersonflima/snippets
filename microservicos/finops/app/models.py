...
class FinopsParams(BaseModel):
    scope: str = Field(default='all', description="Escopo: all | rds | ec2 | ebs | eip | elb | snapshots.")
    lookbackDays: int = Field(default=14, description="Janela (dias) de métricas CloudWatch para detectar ociosidade.")
