"""API do microserviço finops — exposto via API Gateway -> VPC Link -> NLB -> EKS."""
...
from .models import ActionAccepted, ErrorResponse, FinopsRequest

app = FastAPI(title="finops action microservice", version="1.0.0")
