# kms — microserviço action-driven

Cria Custom KMS Key e vincula/re-encripta, substituindo a default.
...
`POST /kms/execute` — executa a ação. Health: `GET /healthz`, `GET /readyz`.
